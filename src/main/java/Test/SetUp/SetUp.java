...
public class SetUp {
  ...
  {
    System.out.println(" Test teardown - Firefox driver quit \n");
  ...
  {
    System.out.println(" Test teardown - Chrome driver quit \n");
    WebHelp.stopWebDriver("Chrome");
  }
  ...
  public void youTubeSetUp()
  {
    ...
    AllPages.currentProductName = "YouTube";
  }
}
